...
contract Charity{
    ...
    function DriverFunction(){
        AddStaticEntity(1046,"Telangana",4);
        AddStaticEntity(1001,"Hyderabad",5);
        AddStaticEntity(1010,"Warangal",6);
        AddEntity(1,"Mohammed Ufraan",1);
        AddEntity(2,"Faheem Ahmed",2);
        AddEntity(3,"Mohd Abrar",3);
